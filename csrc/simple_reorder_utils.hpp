...
public:
  ...
  template <int reg_w>
  static inline reg_type<reg_w> loadu(const int *adrs);
  ...
  template <int reg_w>
  static inline reg_type<reg_w> maskload(const int *adrs, int l);
  ...
  template <int reg_w>
  static inline void storeu(int *, reg_type<reg_w>);
...
inst_policy<avx>::loadu<8> (const int *adrs) {
  return _mm256_loadu_ps((float*)adrs);
}
...
inst_policy<avx>::maskload<8> (const int *adrs, int l) {
  return _mm256_maskload_ps((float*)adrs, mask(l));
}
...
inline void inst_policy<avx>::storeu<8>(int *__p, reg_type<8> __a) {
  _mm256_storeu_ps((float*)__p, __a);
}
...
inline void inst_policy<avx>::maskstore<8> (int *adrs, int l, reg_type<8> a) {
  return _mm256_maskstore_ps((float*)adrs, mask(l), a);
}
