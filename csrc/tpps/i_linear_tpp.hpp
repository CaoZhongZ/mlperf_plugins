...
struct io_policy<col_tile, i_format::plain> {
  ...
  inline static void _mm512_coalescing_store_float(void* C, size_t ldc, int idx, __m512 o0, __m512 o1, __m512 o2, __m512 o3) {
...
struct _tile_dot_product_16x256<1, col_tile, io_policy> {
  ...
  inline static void float_out(void *C, size_t ldc, void *s_0, void *s_1, float *bias, float scale) {
    auto s_0_ = reinterpret_cast<int (*)[2][16][16]>(s_0);
    auto s_1_ = reinterpret_cast<int (*)[2][16][16]>(s_1);
    ...
    for (int t = 0; t < row_tile; ++ t) {
      ...
      for (int i = 0; i < 16; ++ i) {
        ...
        // every 16 got output
        io_policy::_mm512_coalescing_store_float(C_[t], ldc, i, o0*scale_, o1*scale_, o2*scale_, o3*scale_);
      }
    }
  }
...
#   pragma unroll (col_tile)
    ...
    if (o_scale) {
      ...
      float_out(C, ldc, scratch_0, scratch_1, bias, scale);
    }
  }
